...
pub const possible_cpus_mask: std.bit_set.ArrayBitSet(possible_cpus_count) = .initEmpty();
pub var present_cpus_count: u16 = 1;
pub var present_cpus_mask: std.bit_set.ArrayBitSet(possible_cpus_count) = .initEmpty();
pub var online_cpus_count: u16 = 1;
pub var online_cpus_mask: std.bit_set.ArrayBitSet(possible_cpus_count) = .initEmpty();
